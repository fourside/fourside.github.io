...
type Query = {
  ...
  readonly gravatar: Maybe<gravatar>;
  readonly allGravatar: gravatarConnection;
...
type Query_allGravatarArgs = {
  filter: Maybe<gravatarFilterInput>;
  sort: Maybe<gravatarSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type gravatarConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<gravatarEdge>;
  readonly nodes: ReadonlyArray<gravatar>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<gravatarGroupConnection>;
};


type gravatarConnection_distinctArgs = {
  field: gravatarFieldsEnum;
};


type gravatarConnection_maxArgs = {
  field: gravatarFieldsEnum;
};


type gravatarConnection_minArgs = {
  field: gravatarFieldsEnum;
};


type gravatarConnection_sumArgs = {
  field: gravatarFieldsEnum;
};


type gravatarConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: gravatarFieldsEnum;
};
...
type gravatarEdge = {
  readonly next: Maybe<gravatar>;
  readonly node: gravatar;
  readonly previous: Maybe<gravatar>;
};

type gravatarFieldsEnum =
  | 'id'
  | 'parent.id'
  | 'parent.parent.id'
  | 'parent.parent.parent.id'
...
type gravatarGroupConnection_distinctArgs = {
  field: gravatarFieldsEnum;
};


type gravatarGroupConnection_maxArgs = {
  field: gravatarFieldsEnum;
};


type gravatarGroupConnection_minArgs = {
  field: gravatarFieldsEnum;
};


type gravatarGroupConnection_sumArgs = {
  field: gravatarFieldsEnum;
};


type gravatarGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: gravatarFieldsEnum;
};

type gravatarFilterInput = {
  readonly id: Maybe<StringQueryOperatorInput>;
  readonly parent: Maybe<NodeFilterInput>;
  readonly children: Maybe<NodeFilterListInput>;
  readonly internal: Maybe<InternalFilterInput>;
...
type gravatarSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<gravatarFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type BioQuery = { readonly gravatar: Maybe<Pick<gravatar, 'url'>>, readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly author: Maybe<Pick<SiteSiteMetadataAuthor, 'name'>> }> }> };
...
type IndexPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly contentful: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<ContentfulBlogPost, 'title' | 'slug' | 'publishDate'>
        & { readonly body: Maybe<(
          Pick<contentfulBlogPostBodyTextNode, 'body'>
          & { readonly childMarkdownRemark: Maybe<Pick<MarkdownRemark, 'excerpt'>> }
        )> }
      ) }> } };
...
type BlogPostBySlugQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly contentfulBlogPost: Maybe<(
    ...
    & { readonly body: Maybe<{ readonly childMarkdownRemark: Maybe<Pick<MarkdownRemark, 'excerpt' | 'html'>> }> }
  )> };
